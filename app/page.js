  ...
  return (
    <>
      ...
      <main style={{ fontFamily: "Arial, sans-serif", background: pageBg, color: pageText }}>
        ...
        <section id="projects" style={{ padding: "90px 20px", textAlign: "center" }}>
          <h2 style={{ fontSize: "48px", color: "#0b4ea2", marginBottom: "50px" }}>Featured Projects</h2>
          <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "25px" }}>
            {["Ecommerce Platform", "Power Apps Internal Solutions", "Digital Transformation Projects", "Workflow & Process Automation"].map((project, index) => (
              <div key={index} style={{ background: "white", color: "#111", width: "280px", padding: "30px", borderRadius: "18px", boxShadow: "0 10px 25px rgba(0,0,0,0.12)" }}>
                <h3 style={{ color: "#0b4ea2" }}>{project}</h3>
                <p style={{ marginTop: "15px" }}>Professional consulting and implementation solutions.</p>
              </div>
            ))}
          </div>
        </section>

        <section id="blog" style={{ background: "#eef4ff", padding: "90px 20px", textAlign: "center", color: "#111" }}>
          <h2 style={{ fontSize: "48px", color: "#0b4ea2", marginBottom: "20px" }}>Insights & Innovation</h2>
          <p style={{ maxWidth: "850px", margin: "0 auto", fontSize: "20px", lineHeight: "1.8" }}>
            We share insights about business automation, digital transformation, Microsoft technologies, workflow optimization, and innovation strategies.
          </p>
        </section>
        ...
        <section style={{ padding: "90px 20px", background: "#eef4ff", textAlign: "center", color: "#111" }}>
          <h2 style={{ fontSize: "48px", color: "#0b4ea2", marginBottom: "50px" }}>Client Testimonials</h2>
          <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "30px" }}>
            <div style={{ background: "white", width: "380px", padding: "35px", borderRadius: "18px", boxShadow: "0 10px 25px rgba(0,0,0,0.12)", textAlign: "left" }}>
              <p style={{ fontSize: "18px", lineHeight: "1.8", color: "#333" }}>
                "Direholah Consulting helped us establish our online ecommerce presence for African and Caribbean food sales in Sudbury, Ontario. The platform is modern, responsive, and easy for customers to use."
              </p>
              <h3 style={{ marginTop: "25px", color: "#0b4ea2" }}>F & F Global Market</h3>
              <p style={{ color: "#666" }}>African/Caribbean Food Store</p>
              <p style={{ marginTop: "10px", color: "#888", fontSize: "14px" }}>Sudbury, Ontario</p>
            </div>
          </div>
        </section>
        ...
        <footer style={{ background: "#071a3d", color: "white", textAlign: "center", padding: "45px 20px" }}>
          ...
          <div style={{ marginTop: "22px", display: "flex", justifyContent: "center", gap: "22px", flexWrap: "wrap" }}>
            ...
            <a href="mailto:admin@direholahconsulting.com" style={{ color: "white", fontWeight: "bold" }}>Email</a>
          </div>
