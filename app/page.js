    ...
    <>
      ...
      <main style={{ fontFamily: "Arial, sans-serif", background: pageBg, color: pageText }}>
        ...
        <section style={{ textAlign: "center", padding: "110px 20px", background: "linear-gradient(135deg, #071a3d, #0b4ea2, #2563eb)", color: "white" }}>
          ...
          <a href="https://calendly.com/josephkunmi9" target="_blank" style={{ display: "inline-block", marginTop: "25px", padding: "18px 40px", background: "white", color: "#0b4ea2", borderRadius: "12px", textDecoration: "none", fontSize: "20px", fontWeight: "bold", boxShadow: "0 8px 20px rgba(0,0,0,0.2)" }}>
        ...
        <section id="projects" style={{ padding: "90px 20px", textAlign: "center", background: "#eef4ff" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "35px" }}>
            <div style={{ background: "white", width: "420px", borderRadius: "20px", overflow: "hidden", boxShadow: "0 10px 25px rgba(0,0,0,0.15)", textAlign: "left" }}>
              <img src="/ffglobalmarket.png" alt="F and F Global Market Ecommerce Platform" style={{ width: "100%", height: "260px", objectFit: "cover" }} />
              <div style={{ padding: "25px" }}>
                <h3 style={{ color: "#0b4ea2", fontSize: "28px", marginBottom: "15px" }}>F & F Global Market</h3>
                ...
                <a href="https://ffglobalmarket.vercel.app" target="_blank" style={{ display: "inline-block", padding: "12px 24px", background: "#0b4ea2", color: "white", borderRadius: "10px", textDecoration: "none", fontWeight: "bold" }}>
                  View Live Project
                </a>
              </div>
            </div>
            ...
            <div style={{ background: "white", width: "420px", borderRadius: "20px", overflow: "hidden", boxShadow: "0 10px 25px rgba(0,0,0,0.15)", textAlign: "left" }}>
              <img src="/naomifoods.png" alt="Naomi Foods Ecommerce Website" style={{ width: "100%", height: "260px", objectFit: "cover" }} />
              <div style={{ padding: "25px" }}>
                <h3 style={{ color: "#0b4ea2", fontSize: "28px", marginBottom: "15px" }}>Naomi Foods</h3>
                <p style={{ color: "#444", lineHeight: "1.7", marginBottom: "20px" }}>
                ...
                <a href="https://naomifoods.com/index" target="_blank" style={{ display: "inline-block", padding: "12px 24px", background: "#0b4ea2", color: "white", borderRadius: "10px", textDecoration: "none", fontWeight: "bold" }}>
                  View Live Project
                </a>
              </div>
            </div>
        ...
        <section id="case-studies" style={{ padding: "100px 20px", background: "#ffffff", textAlign: "center", color: "#111" }}>
          <h2 style={{ fontSize: "52px", color: "#0b4ea2", marginBottom: "20px" }}>Case Studies</h2>
          <p style={{ maxWidth: "900px", margin: "0 auto 60px", fontSize: "20px", lineHeight: "1.8", color: "#444" }}>
            Real business challenges transformed into digital solutions through innovation, automation, and modern technology.
          </p>
            ...
            {[
              {
                ...
                challenge: "The client needed a modern ecommerce platform to allow customers in Sudbury to browse and purchase African and Caribbean products online.",
                solution: "Direholah Consulting designed and developed a responsive ecommerce solution with product catalog management, shopping cart functionality, inventory display, and mobile-friendly design.",
                tech: "Next.js • React • Firebase • Vercel",
                outcome: "The business gained a professional online presence with improved customer accessibility and digital ordering capability.",
              },
              {
                name: "Naomi Foods",
                challenge: "Naomi Foods required a scalable ecommerce grocery platform to showcase products, simplify online shopping, and modernize customer engagement.",
                solution: "Direholah Consulting delivered a modern ecommerce website with categorized products, responsive storefront design, customer-focused shopping experience, and improved digital branding.",
                tech: "Ecommerce Platform • Responsive Design • Web Optimization",
                outcome: "The store strengthened its digital presence and improved customer accessibility for online grocery shopping in Brantford, Ontario.",
              },
            ].map((item, index) => (
              <div key={index} style={{ background: "#f8f9fc", width: "420px", padding: "35px", borderRadius: "20px", textAlign: "left", boxShadow: "0 10px 25px rgba(0,0,0,0.08)" }}>
                <h3 style={{ color: "#0b4ea2", fontSize: "30px", marginBottom: "20px" }}>{item.name}</h3>
                <h4 style={{ color: "#222" }}>Challenge</h4>
                <p style={{ lineHeight: "1.8", color: "#555" }}>{item.challenge}</p>
                <h4 style={{ marginTop: "20px", color: "#222" }}>Solution</h4>
                <p style={{ lineHeight: "1.8", color: "#555" }}>{item.solution}</p>
                <h4 style={{ marginTop: "20px", color: "#222" }}>Technologies Used</h4>
                <p style={{ color: "#555" }}>{item.tech}</p>
                <h4 style={{ marginTop: "20px", color: "#222" }}>Outcome</h4>
                <p style={{ lineHeight: "1.8", color: "#555" }}>{item.outcome}</p>
              </div>
            ))}
          </div>
        </section>

        <section id="testimonials" style={{ padding: "90px 20px", background: "#ffffff", textAlign: "center", color: "#111" }}>
          <h2 style={{ fontSize: "48px", color: "#0b4ea2", marginBottom: "50px" }}>Client Testimonials</h2>
          <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "30px" }}>
            <div style={{ background: "#f8f9fc", width: "380px", padding: "35px", borderRadius: "18px", boxShadow: "0 10px 25px rgba(0,0,0,0.08)", textAlign: "left" }}>
              <p style={{ fontSize: "18px", lineHeight: "1.8", color: "#333" }}>
                "Direholah Consulting helped us establish our online ecommerce presence for African and Caribbean food sales in Sudbury, Ontario."
              </p>
              <h3 style={{ marginTop: "25px", color: "#0b4ea2" }}>F & F Global Market</h3>
              <p style={{ color: "#666" }}>African/Caribbean Food Store</p>
            </div>

            <div style={{ background: "#f8f9fc", width: "380px", padding: "35px", borderRadius: "18px", boxShadow: "0 10px 25px rgba(0,0,0,0.08)", textAlign: "left" }}>
              <p style={{ fontSize: "18px", lineHeight: "1.8", color: "#333" }}>
                "Professional ecommerce solution with responsive design, product management, and smooth shopping experience for our customers."
              </p>
              <h3 style={{ marginTop: "25px", color: "#0b4ea2" }}>Naomi Foods</h3>
              <p style={{ color: "#666" }}>Grocery Store — Brantford, Ontario</p>
            </div>
          </div>
        </section>
        ...
        <section id="booking" style={{ textAlign: "center", padding: "100px 20px" }}>
          ...
          <a href="https://calendly.com/josephkunmi9" target="_blank" style={{ display: "inline-block", padding: "18px 40px", background: "#0b4ea2", color: "white", borderRadius: "12px", textDecoration: "none", fontSize: "20px", fontWeight: "bold" }}>
        ...
        <footer style={{ background: "#071a3d", color: "white", textAlign: "center", padding: "45px 20px" }}>
          ...
          <div style={{ marginTop: "22px", display: "flex", justifyContent: "center", gap: "22px", flexWrap: "wrap" }}>
            <a href="https://www.linkedin.com/company/direholah-consulting/" target="_blank" style={{ color: "white", fontWeight: "bold" }}>LinkedIn</a>
            <a href="https://www.instagram.com/direholahconsulting/" target="_blank" style={{ color: "white", fontWeight: "bold" }}>Instagram</a>
            <a href="https://www.tiktok.com/@direholahconsulting" target="_blank" style={{ color: "white", fontWeight: "bold" }}>TikTok</a>
            <a href="https://www.youtube.com/@DireholahConsulting" target="_blank" style={{ color: "white", fontWeight: "bold" }}>YouTube</a>
          </div>
