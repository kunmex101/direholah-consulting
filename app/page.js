    ...
    >
        ...
        >
          {[
            [
              ...
              "Professional websites for businesses and organizations.",
            ],
            [
              "Power Platform Automation",
              "Workflow automation using Microsoft Power Apps and Power Automate.",
            ],
            [
              "Community Digital Platform",
              "Digital solutions for churches, communities, and startups.",
            ],
      ...
      >
        ...
        >
          {[
            ...
            "Excellent consulting and automation expertise.",
          ].map((review, index) => (
            <div
              key={index}
              style={{
      ...
      >
        ...
        >
          ...
          business, technology, automation, or
          project needs.
        </p>
        ...
        >
          {[
            [
              ...
              "Automation saves time and improves operations.",
            ],
            [
              "Power Apps for Modern Teams",
              "Microsoft Power Platform helps organizations build custom tools quickly.",
            ],
            [
              "Digital Transformation Made Simple",
              "Transformation starts with people and practical technology.",
            ],
          ].map(([title, text], index) => (
            <article
              key={index}
